module opendatahub.com/tr-dss-webcams
...
require (
	...
	opendatahub.com/tr-dss-webcams/dto v0.0.0-00010101000000-000000000000
	opendatahub.com/tr-dss-webcams/odhmodel v0.0.0-00010101000000-000000000000
)

replace (
	opendatahub.com/tr-dss-webcams/dto => ./dto
	opendatahub.com/tr-dss-webcams/odhmodel => ./odh-content-model
)
