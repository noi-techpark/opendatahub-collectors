...
type ProviderA22 struct {
	...
	FasciaOraria      string    `json:"FasciaOraria"`
	Idcorsia          string    `json:"Idcorsia"`
	Iddirezione       string    `json:"Iddirezione"`
	MetroInizio       string    `json:"MetroInizio"`
	MetroFine         string    `json:"MetroFine"`
	Idsottotipoevento string    `json:"Idsottotipoevento"`
}
