module opendatahub.com/tr-dss-lift
...
require (
	...
	opendatahub.com/tr-dss-lift/dto v0.0.0-00010101000000-000000000000
	opendatahub.com/tr-dss-lift/odhmodel v0.0.0-00010101000000-000000000000
)

replace (
	opendatahub.com/tr-dss-lift/dto => ./dto
	opendatahub.com/tr-dss-lift/odhmodel => ./odh-content-model
)
